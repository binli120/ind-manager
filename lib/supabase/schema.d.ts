    ...
    Tables: {
      ...
      prompt_analysis_results: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "prompt_analysis_results_experiment_variant_id_fkey";
      ...
      prompt_performance_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "prompt_performance_metrics_experiment_variant_id_fkey";
            columns: ["experiment_variant_id"];
            isOneToOne: false;
            referencedRelation: "prompt_experiment_variants";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName:
              "prompt_performance_metrics_prompt_template_id_fkey";
